...
class ReservationRepositoryTest {
    ...
    public void getReservation_test() {
    ...
    @Test
    public void getReservationByRefTest() {
        ...
        ReservationStatusEnum reservationStatusEnum = ReservationStatusEnum.PENDING;
        Reservation reservation = new Reservation(123.3, "11/11/22", "12/12/22", appUser, property, "132", reservationStatusEnum);
        Mockito.when(reservationRepository.findReservationByRefNumber(refNumber)).thenReturn(Optional.of(reservation));
        assertEquals(reservation, reservationService.getReservationByRef(refNumber));
    }
